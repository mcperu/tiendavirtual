<!-- Modal -->
<div class="modal fade" id="modalFormCategoriados" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="tile">
            ...
            <div class="tile-body">
              <form id="formCategoriados" name="formCategoriados">
                <input type="hidden" id="idcategoriados" name="idcategoriados" value="">
                <div class="form-group">
                  <label class="control-label">Nombre</label>
                  <input class="form-control" type="text" id="txtNombre" name="txtNombre" placeholder="Nombre de la subcategoría">
                </div>
                <div class="form-group">
                    <label for="listCategoriaunoid">Categoría</label>
                    <select class="form-control" data-live-search="true" id="listCategoriaunoid" name="listCategoriaunoid" required >
                    </select>
                </div>
                <div class="form-group">
