...
document.addEventListener('DOMContentLoaded', function(){
    ...
    formUsuario.onsubmit = function(e) {
        ...
        if(strDni == '' || strApellido == '' || strNombre == '' || strEmail == '' || intTelefono == '' || intTipousuario == '')
        {
        ...
        request.onreadystatechange = function(){
            if(request.readyState == 4 && request.status == 200){
              /*   console.log(request.responseText);
                ...
                if(objData.status)
                {
                    let intStatus = document.querySelector('#txtPassword').value;
       ...
       if(document.querySelector("#formPerfil")){
        ...
        formPerfil.onsubmit = function(e) {
            ...
            if(strDni == '' || strApellido == '' || strNombre == '' || intTelefono == '' )
            {
                swal("Atención", "Todos los campos son obligatorios." , "error");
                return false;
            }
    ...
    if(document.querySelector("#formDataFiscal")){
        ...
        formDataFiscal.onsubmit = function(e) {
            ...
            if(strRuc == '' || strRazonSocial == '' || strDirFiscal == '' )
            {
                swal("Atención", "Todos los campos son obligatorios." , "error");
                return false;
            }
